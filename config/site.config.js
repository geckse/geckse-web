...
const config = {
  ...
  site_name: 'geckse - developer & graphic designer',

  // Your website's description, used for favicon meta tags
  site_description: 'I code and design digital products. Berlin based developer & graphic designer.',

  // Your website's URL, used for sitemap
  site_url: 'https://geckse.de',
